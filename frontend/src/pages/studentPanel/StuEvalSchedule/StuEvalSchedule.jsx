...
import styles from "./stuEvalSchedule.module.css";

const StudentEvalSchedule = () => {
    ...
    return (
      ...
      />
        <p className={styles.note}>The Schedule is not available yet.</p>
        </>
    )
}

export default StudentEvalSchedule;