...
import styles from './adminVerifyDoc.module.css'; // Import the module CSS
  ...
  return (
    <>
     <Navbar
         ...
         />
    <div className={`min-h-screen ${styles.gradientBackground} py-12 px-4 sm:px-6 lg:px-8`}>
      <div className="max-w-3xl mx-auto">
        <div className={`bg-white shadow-xl rounded-lg overflow-hidden ${styles.cardContainer}`}>
                    ...
                    key !== "trainingLetter" && key !== "feeReceipt" && (
                      <div key={key} className="space-y-2">
                        ...
                        <input
                          ...
                          className={`${styles.inputField} ${key === "name" || key === "rollNo" || key === "email" || key === "phoneNumber" ? styles.disabledInput : ""}`}
                        />
                      </div>
                    )
                  ))}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="space-x-2">
                      ...
                      <button type="button" onClick={() => handleRemoveAndEmail("trainingLetter",formData.rollNo)} 
                        className={`text-white bg-purple-600 hover:bg-purple-700 px-3 py-1 rounded-md disabled:opacity-50 ${isProcessing && processingFileType === "trainingLetter" ? styles.processingButton : ""}`}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="space-x-2">
                      ...
                      <button type="button" onClick={() => handleRemoveAndEmail("feeReceipt",formData.rollNo)} 
                        className={`text-white bg-purple-600 hover:bg-purple-700 px-3 py-1 rounded-md disabled:opacity-50 ${isProcessing && processingFileType === "feeReceipt" ? styles.processingButton : ""}`}
                        disabled={isProcessing}>
