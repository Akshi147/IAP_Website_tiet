    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-purple-50 to-white px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-semibold mb-2">Mentor Password Reset</h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6 text-center">
            <Link to="/mentor" className="text-purple-600 hover:text-purple-700">
...
export default ForgotMentorPassword;
